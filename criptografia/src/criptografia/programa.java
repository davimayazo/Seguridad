...
public class programa {
	...
	private static void cifradoRSA(String archivo, String clavePublica) throws Exception {
				...
				for (byte b: encriptado) {
					pw.println(Integer.toHexString(0xFF & b));
				}
				
	}
	
	private static void descrifradoRSA(String archivo, String clavePrivada)  throws Exception {
	...
	private static void descrifradoAES(String archivo, String clave) throws Exception {
