...
public class programa {
	...
	public static void main(String[] args) throws Exception {
		...
		while (!salir) {
			...
			System.out.println("4.- Hash de contraseÒas");
					...
					while (!salirRSA) {
						...
						try {
							...
							case 2:
								...
								System.out.println("EjecuciÛn cifrado RSA: " + endTime);
								break;
							case 3:
								...
								System.out.println("EjecuciÛn descifrado RSA: " + endTime2);
								break;
							case 4:
								salirRSA = true;
								break;
					...
					while (!salirAES) {
						...
						try {
							...
							case 2:
								...
								long endTime = System.currentTimeMillis() - startTime;
								System.out.println("EjecuciÛn cifrado AES: " + endTime);
								break;
							case 3:
								System.out.print("Introduce el archivo a descifrar: ");
								String archivo2 = sc.next();
								...
								long endTime2 = System.currentTimeMillis() - startTime2;
								System.out.println("EjecuciÛn descifrado AES: " + endTime2);
								break;
							case 4:
								salirAES = true;
								break;
					...
					while (!salirDES) {
						...
						try {
							...
							case 2:
								...
								long endTime = System.currentTimeMillis() - startTime;
								System.out.println("EjecuciÛn cifrado DES: " + endTime);
								break;
							case 3:
								System.out.print("Introduce el archivo a descifrar: ");
								String archivo2 = sc.next();
								...
								long endTime2 = System.currentTimeMillis() - startTime2;
								System.out.println("EjecuciÛn cifrado DES: " + endTime2);
								break;
							case 4:
								salirDES = true;
								break;
				...
				case 4:
					while (!salirPass) {
						...
						try {
							...
							switch (opcion) {
							case 1:
								System.out.print("Introduce la contraseÒa: ");
								String pass = sc.next();
